# Currency Exchange and _The Answer_

This repository contains two separate blockchain-based demonstration applications:

1. Currency Exchange - Turn FIAT currencies into ETHER.
2. The Answer - receive _The Answer_ to any question (hint: 42).
